...
const Howitworks = () => {
  return (
    <div className="Howitworks-container" id="Howitworks">
      ...
      <p id="Howitworks-paragraph">
        Obtén más que un sitio web. Déjanos ayudarte a hacer realidad tu visión
        y maximizar tu presencia en línea con nuestro diseño, estrategia y
        experiencia.
      </p>
      <div className="Howitworks-benefits-container">
        <Benefitcard
          imgUrl={pincel}
          headingText="Diseño rapido"
          text="Podrás ver como quedará tu sitio web en tan solo días"
          idcolor="benefit_blue"
        />
        <Benefitcard
          imgUrl={time}
          headingText="Respuesta rápida"
          text="Estamos disponibles para cuando lo necesites"
          idcolor="benefit_purple"
        />
        <Benefitcard
          imgUrl={lowPrice}
